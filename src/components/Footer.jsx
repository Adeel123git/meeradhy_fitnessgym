...
const Footer = () => {
  ...
  return (
    <footer className="bg-trabs from-gray-900 via-black to-gray-900 text-white">
      <div className="footer-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed">
              Transform your life with our state-of-the-art facilities and expert trainers. Your fitness journey starts here.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="w-10 h-10 bg-gradient-to-r from-red-500 to-orange-500 rounded-full flex items-center justify-center hover:from-red-600 hover:to-orange-600 transform hover:scale-110 transition-all duration-300"
          ...
          {/* Programs */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-red-500">Our Programs</h3>
            <ul className="space-y-2">
              {programs.map((program) => (
                <li key={program} className="text-gray-300 hover:text-red-500 transition-colors duration-300 flex items-center group cursor-pointer">
                  <span className="w-2 h-2 bg-red-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  {program}
                </li>
              ))}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">Mon - Fri: 6AM - 10PM<br />Sat - Sun: 8AM - 8PM</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <div className="text-center md:text-left md:flex md:items-center md:justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-300">Subscribe to our newsletter for fitness tips and updates</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto md:mx-0">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-2 bg-gray-800 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
              />
              <button className="px-6 py-2 bg-gradient-to-r from-red-500 to-orange-500 text-white font-medium rounded-lg hover:from-red-600 hover:to-orange-600 transform hover:scale-105 transition-all duration-300">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="text-gray-400 mb-4 md:mb-0">
            © 2026 FitnessGym. All rights reserved. | Designed with ❤️ for fitness enthusiasts
          </p>
